  ...
  <?php if ($user_id): ?>
    <?php if (!empty($problem['template'])): ?>
      <p style="font-size: 0.85em; color: #666;">
        Tip: Verify your proof on the <strong><a href="https://live.lean-lang.org/" target="_blank">Lean 4 Web Editor</a></strong>, <strong><a href="https://axle.axiommath.ai/verify_proof" target="_blank">AXLE Verify</a></strong>, or <strong><a href="https://axle.axiommath.ai/check" target="_blank">AXLE Check</a></strong>. You can also optimize it using <strong><a href="https://axle.axiommath.ai/simplify_theorems" target="_blank">AXLE Simplify</a></strong>.
      </p>
