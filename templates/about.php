<div class="markdown">
    ...
    Welcome to the **Lean Online Judge**! Here is a quick guide on how to get started reading and submitting formal
    proofs.

    ### 1. Find a Problem
    Head over to the **[Problems](index.php?action=view_problems)** page. You will see a list of mathematical challenges
    translated into Lean 4 theorem signatures. Choose a problem by clicking on its title.

    ### 2. Understand the Statement
    The problem page displays the informal mathematical statement along with the formal Lean `theorem` signature. Your
    goal is to write a Lean proof that successfully replaces the `sorry` and satisfies the theorem type.
    ...
    **Tip:** You can use the **[Lean 4 Web Editor](https://live.lean-lang.org/)**, **[AXLE
    ...
    verify your proof in real-time. You can also use **[AXLE Simplify](https://axle.axiommath.ai/simplify_theorems)** to
    optimize your theorems before submitting.

    ### 4. Submit and Wait for Judgment
    Once you click submit, your code is placed into a queue. Our backend worker will compile your Lean code using the
    Lean 4 compiler.
    ...
    - **ERROR / TIMEOUT:** Your code failed to compile, contained an unresolved `sorry`, or took too long to verify. You
    can review the *Compiler Log* directly on your submission's detail page to see why it failed.
